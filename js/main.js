...
PROJECTS: CCWPrep (KTU Exam Platform), PriceTrail (Flutter+Gemini AI), Devanagari Classifier (97.55% CNN+Docker), BlindFold (Privacy-first forensics), CivilSupply Connect (supply chain), Malayalam OCR (in progress), XmasFriendPicker (live at xmasfriendpicker.onrender.com)
...
WINS: Product Matters 5.0 (E-Cell IITG 2025) | 1st National Virtual Stock Market NIT Calicut Aug 2024 | Rank 68/124 BURNOUT Kaggle | Innovate 2.0 Hackathon IEEE Kerala Feb 2026 | IEEE RAS ROS Workshop | NPTEL Elite Cryptography IIT Kharagpur 75%
